var jakepng , pathpng, path, jake, left_boundary, right_boundary,  coin, coinpng, coinscore,song;
function preload(){
 
  jakeImg=loadAnimation("jake1.png", "jake2.png", "jake3.png", "jake4.png", "jake5.png");
  pathImg=addAnimation("path.png");
  
  coinImg=addAnimation("coin.png");
}

function setup(){
  createCanvas(400,400);
  path=createSprite(200,200);
  path.addAnimation(pathpng);
  path.velocityY=5;
  path.y=path.height/30;
  jake=createSprite(180,340,50,170);
  jake.addAnimation("running", jakepng);
  
  
  coin=createSprite(200,200,80,90);
  coin.addAnimation(coinpng);
  coin.scale=0.3
